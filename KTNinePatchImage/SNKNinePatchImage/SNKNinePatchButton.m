...
#import "SNKNinePatchButton.h"
#import "SNKNinePatchImageCache.h"
#import <UIButton+YYWebImage.h>
#import <YYDiskCache.h>

@interface SNKNinePatchButton ()
...
@implementation SNKNinePatchButton
...
{
    NSAssert(self.superview && paddingView.superview && self.superview == paddingView.superview, @"paddingView 和 SNKNinePatchButton 应该公有一个父 view");
...
- (void)setBackgroundImageWithUrlStr:(NSString *)urlStr
{
    ...
    __weak SNKNinePatchButton *weakSelf = self;
    [self yy_setBackgroundImageWithURL:[NSURL URLWithString:urlStr]
...
- (void)setNinePatchImage:(SNKNinePatchImage *)ninePatchImage
{
    ...
    [self setBackgroundImage:ninePatchImage.image forState:UIControlStateNormal];
    if (ninePatchImage) {
        [self p_updateConstraints];
    }
}
